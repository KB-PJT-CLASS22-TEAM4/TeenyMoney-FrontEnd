...
async function handleDeletePayment(
  ...
  const confirmed =
    window.confirm(
      `${getPaymentName(payment)} 카드를 삭제하시겠습니까?`
    )
